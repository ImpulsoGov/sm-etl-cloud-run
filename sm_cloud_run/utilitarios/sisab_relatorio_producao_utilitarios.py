...
from utilitarios.sisab_producao_modelos import SisabRelatorioProducao, TIPOS_IDADE, TIPOS_PRODUCAO
...
def _gerar_relatorios_producao_por_municipio(
    ...
    for parametros in combinacoes_parametros:
        ...
        logging.info("Iniciando requisição {} de {}...".format(
            requisicao_num,
            total_requisicoes,
        ))
        selecoes_combinacao = {
...
def extrair_producao_por_municipio(
    ...
    logging.info("Extraindo relatório de produção do SISAB...")
